...
- Rejection-aware — don't re-raise a finding the human already rejected; verify a `fixed` finding on re-run. Output ONLY through `docspec audit`, never a hand-edit of `audit.yaml`.
