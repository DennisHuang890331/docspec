...
- Copy the dispatch-exclusion list verbatim into every semantic subagent brief; punctuation width → `docspec normalize` (engine-deterministic, code/URLs byte-exact), never a hand-rolled full-text width sweep or a blind regex.
