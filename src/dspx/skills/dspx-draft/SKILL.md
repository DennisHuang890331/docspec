...
- No silent overrides. If your draft would contradict a decision, do NOT write around it — emit a `[!WARNING]` block naming the decision and stop on that section.
